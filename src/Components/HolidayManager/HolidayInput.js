...
const App = () => {
  ...
  const validateForm = () => {
    ...
    else if (description.length < 5) newErrors.description = "Description should be at least 5 characters";
            ...
            <div style={{ display: 'flex', flexDirection: 'row' }}>
              ...
              <div style={{ marginBottom: '20px', marginLeft: 40 }}>
                ...
                <input
                  ...
                  style={{ width: '200px', padding: '10px', borderRadius: '15px', border: '1px solid #ccc', marginTop: '5px' }}
                />
                {errors.type && <div style={{ color: 'red', fontSize: '12px' }}>{errors.type}</div>}
              </div>
            </div>
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                ...
                <tbody>
                  ...
                  {filteredHolidays.length === 0 && (
                    <tr><td colSpan="3" style={{ padding: '10px', textAlign: 'center', color: 'gray' }}>No holidays found.</td></tr>
                  )}
                </tbody>
              </table>
            </div>
